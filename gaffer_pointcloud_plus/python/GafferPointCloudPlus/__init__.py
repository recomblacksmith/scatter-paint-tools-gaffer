...
_GafferPointCloudPlus, _GAFFER_POINT_CLOUD_PLUS_IMPORT_ERROR = _load_extension(
    "_GafferPointCloudPlus", "lib_GafferPointCloudPlus"
)

if _GafferPointCloudPlus is not None:
    PointCloudPlus = _GafferPointCloudPlus.PointCloudPlus
else:
    PointCloudPlus = None
