...
_GafferScatterPlus, _GAFFER_SCATTER_PLUS_IMPORT_ERROR = _load_extension(
    "_GafferScatterPlus", "lib_GafferScatterPlus"
)

if _GafferScatterPlus is not None:
    ScatterPlus = _GafferScatterPlus.ScatterPlus
else:
    ScatterPlus = None
